# -*- coding: utf-8 -*-
"""neural Assignment-2 700746372 .ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1mIPd9M2_WIh6RNPV9jb-6JDQvO6Q22PT
"""
...
for line in lines:
    ...
    wordcounterline.append(Counter(words))
...
print("Word_Count:")
for word, count in Counter(word for wc in wordcounterline for word in wc).items():
    print(f"{word}: {count}")
